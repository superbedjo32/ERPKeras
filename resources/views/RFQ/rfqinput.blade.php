                        ...
                        <div class="container-fluid mt-4">
                            <div class="card">
                                <div class="card-body mt-3">
                                    <!-- Vendor ID -->
                                    <input type="hidden" id="vendor-id" name="vendor_id" readonly class="form-control" value="{{ old('vendor_id') }}">

                                    <!-- Total Harga -->
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Total Harga</label>
                                        <div class="col-sm-10">
                                            <input type="text" id="val" name="total_harga" readonly class="form-control" value="{{ old('total_harga') }}">
                                        </div>
                                    </div>
